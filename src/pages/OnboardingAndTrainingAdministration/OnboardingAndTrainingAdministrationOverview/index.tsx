...
type OnboardingAndTrainingAdministrationOverviewType = RouteProps;

const OnboardingAndTrainingAdministrationOverview: React.FC<OnboardingAndTrainingAdministrationOverviewType> = () => {
...
export default OnboardingAndTrainingAdministrationOverview;
