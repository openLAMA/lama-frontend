...
export const checkTestingPersonalInvitationConfirmationAPI = async (
  data: TestingPersonalInvitationConfirmationRequestType,
): Promise<TestingPersonalInvitationConfirmationResponseType> =>
  HttpClient.request<TestingPersonalInvitationConfirmationResponseType>({
    url: 'laboratory/invitations/confirm',
