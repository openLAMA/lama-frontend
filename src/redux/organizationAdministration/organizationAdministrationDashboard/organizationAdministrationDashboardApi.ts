...
export const getOrganizationAPI = async (
  params: GetOrganizationDashboardInfoRequestType,
): Promise<GetOrganizationDashboardResponseType> =>
  HttpClient.request<GetOrganizationDashboardResponseType>({
    url: 'organizations/dashboardInfo',
