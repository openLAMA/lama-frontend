...
export const inviteLaboratoryCapacityStudentsAPI = async (
  data: InviteLaboratoryCapacityStudentsRequestType,
): Promise<InviteLaboratoryCapacityStudentsResponseType> =>
  HttpClient.request<InviteLaboratoryCapacityStudentsResponseType>({
    url: 'laboratory/invitations',
