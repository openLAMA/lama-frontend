...
export type GetLaboratoryTestingPersonalType = {
  ...
  result: LaboratoryTestingPersonalResultType[] | null;
};

export type LaboratoryTestingPersonalStatusType = {
  id: string;
  name: string;
};

export type GetLaboratoryTestingPersonResponse = GetLaboratoryTestingPersonalType;

export type GetLaboratoryTestingPersonalStatusTypesListResponse = LaboratoryTestingPersonalStatusType[];

export type AddLaboratoryTestingPersonalRequestType = AddLaboratoryTestingPersonalType;

export type DeleteLaboratoryTestingPersonRequestType = {
  id: string;
};
